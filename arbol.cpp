...
bool buscarPreorden(arbol raiz, int valor){
    ...
    if(buscarPreorden(raiz->izq,valor)){
        
        return true;
        
    }
    
    if(buscarPreorden(raiz->der,valor)){
...
bool buscarPostorden(arbol raiz, int valor){
    ...
    if(buscarPostorden(raiz->izq,valor)){
        
        return true;
        
    }
    
    if(buscarPostorden(raiz->der,valor)){
...
void mostrarArbolPreorden(arbol& raiz){
    ...
    mostrarArbolPreorden (raiz -> izq);
    
     mostrarArbolPreorden (raiz -> der);
...
void mostrarArbolPostorden(arbol& raiz){
    ...
    mostrarArbolPostorden(raiz ->izq);
    
    mostrarArbolPostorden(raiz->der);
                ...
                switch (form){
			 		...
			 		case 1:
						...
						if (valor != 0) {
                         	...
                         	bool encontrado = buscarPreorden(raiz, valor);
					...
					break;  
			 		...
			 		case 3:
						...
						if (valor != 0) {
                         	...
                         	bool encontrado = buscarPostorden(raiz, valor);
                ...
                switch (form){
                	...
                	case 1:
						...
						if (raiz != NULL){
							...
							cout << "Mostrando los datos en Preorden:" << endl << endl;
                	...
                	case 3:
						...
						if (raiz != NULL){
							...
							cout << "Mostrando los datos en Postorden:" << endl << endl;
